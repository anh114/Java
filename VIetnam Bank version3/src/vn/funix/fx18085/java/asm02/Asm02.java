...
public class Asm02 {
    ...
    public static void themKhachHang() {
                ...
                sc.nextLine();
                    ...
                    Customer cus = getCustomerById(cccd);
                    if (cus == null && cus.checkIdAvailable(cccd)) {
                        //add CCCD moi vao
                        Customer c = new Customer(cccd, name);
                        bank.setCustomers(c);
                    } else {
    ...
    public static void themTaiKhoan() {
        ...
        if (!bank.isCustomerExisted(xacMinhCCCD)) {
            ...
            if (soDu < 50000) {
                ...
                //update Account moi
                Account newAcc = new Account(accNumber, soDu, true);
                Customer cus = getCustomerById(xacMinhCCCD);
    ...
    public static Customer getCustomerById (String cccd){
        ...
        return null;
            ...
            public static void timTheoCCCD () {
                ...
                for (Customer cus : bank.getCustomers()) {
                    if (cus.getCustomerId().equals(currentCccd)) {
